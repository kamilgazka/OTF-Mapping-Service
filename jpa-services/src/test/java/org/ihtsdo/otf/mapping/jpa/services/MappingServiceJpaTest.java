<<<<<<< HEAD:jpa-services/src/test/java/org/ihtsdo/otf/mapping/jpa/services/MappingServiceTest.java
...
//		}
//		
//		if (specialists.get(4).getEmail().compareTo("graeme.miller@sydney.edu.au") != 0) {
//			fail("Retrieval - getMapSpecialists():  Map specialist email for lead 5 not equal to 'graeme.miller@sydney.edu.au'");
//		}
//		
//		// TODO test records
//		
...
//				
//		if (s.getEmail().compareTo("graeme.miller@sydney.edu.au") != 0) {
//			fail("Retrieval - getMapSpecialist(Long id):  Map specialist email for lead 5 not equal to 'graeme.miller@sydney.edu.au'");
//		}
//		
//		// get lead (id)
...
>>>>>>> 7dbcfd5d40bd5da7683d5268c2ff2f3cd0436dfa:jpa-services/src/test/java/org/ihtsdo/otf/mapping/jpa/services/MappingServiceJpaTest.java
